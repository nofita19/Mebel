...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2021 at 05:52 PM
...
ALTER TABLE `transaksi_pembelian`
  ...
  ADD UNIQUE KEY `id` (`kode_pembelian`),
  ADD KEY `id_2` (`kode_pembelian`),
...
--
ALTER TABLE `transaksi_penjualan`
  ADD CONSTRAINT `transaksi_penjualan_ibfk_1` FOREIGN KEY (`id_jenis_pembayaran`) REFERENCES `jenis_pembayaran` (`id_jenis_pembayaran`);
COMMIT;
